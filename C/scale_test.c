...
int main(int argc, char *argv[]) {
    MPI_Init(NULL, NULL);
    int i, rank, size, indirect_overflow, direct_overflow, mostly_ok_int, intermediate_calc, intermediate_end, pointer_calc;
    ...
    printf("Rank %d; mostly_ok_int=%d, direct_overflow=%d, indirect_overflow=%d, user_input_result=%d, intermediate_end=%d, pointer_calc=%d\n", 
           rank, mostly_ok_int, direct_overflow, indirect_overflow, user_input_result, intermediate_end, pointer_calc);
