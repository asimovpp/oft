...
namespace oft {
    ...
    */
    void ScaleOverflowIntegerDetection::findInstructions(scale_node* node, std::unordered_set<Instruction*> *overflowable_int_instructions, std::unordered_set<scale_node*> & visited) {
        ...
        for (scale_node* n : node->children) findInstructions(n, overflowable_int_instructions, visited);
    }
